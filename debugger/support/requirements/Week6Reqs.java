...
public abstract class Week6Reqs implements DebuggerCollisionFunctions {
	...
	public abstract float raycast(AABDebugger s1, RayDebugger s2);
	public abstract float raycast(CircleDebugger s1, RayDebugger s2);
	public abstract float raycast(PolygonDebugger s1, RayDebugger s2);
